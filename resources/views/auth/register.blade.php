...
<div class="main-div">
  <div class="panel">
   <img src="{{ asset('image/logo.png') }}" alt="">
    ...
    <form id="Login" class="form-signin" method="POST" action="{{ route('register') }}">
        @csrf
        <div class="form-group">
          <label for="name" class="sr-only">Nama Lengkap</label>
          <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus placeholder="Masukkan Nama Lengkap Anda">
          @if ($errors->has('name'))
        ...
        <div class="form-group">
          ...
          <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required placeholder="Masukkan Alamat Email Anda">
          @if ($errors->has('email'))
              <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group">
          <label for="password_confirmation" class="sr-only">Ulang Kata Sandi</label>
